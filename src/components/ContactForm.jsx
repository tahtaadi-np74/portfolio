        ...
        <div className="bg-white rounded shadow p-10 mt-7 mx-auto lg:w-2/4 md:w-3/4 w-full">
            ...
            <form onSubmit={handleSubmit}>
                <div className="mb-3">
                    ...
                    <input type="text" id="name" name="name" value={formData.name} onChange={handleChange} className="block border border-slate-500 rounded indent-3 text-black h-10 w-full" />
                </div>
                <div className="mb-3">
                    <label htmlFor="email" className="block text-black text-md mb-2">Email</label>
                    <input type="email" id="email" name="email" value={formData.email} onChange={handleChange} className="block border border-slate-500 rounded indent-3 text-black h-10 w-full" />
                </div>
                <div className="mb-5">
                    <label htmlFor="message" className="block text-black text-md mb-2">Message</label>
                    <textarea id="message" name="message" value={formData.message} onChange={handleChange} className="block border border-slate-500 rounded text-black p-3 w-full" cols="30" rows="10"></textarea>
                </div>
